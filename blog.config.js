...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '0527fd0d0d1047b489af30a7822d842e',
  ...
  AUTHOR: 'oldl', // 作者
  BIO: '一个普通的老李', // 作者简介
  LINK: 'https://oldl.net', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'limengde#yeah.net', // 邮箱
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '', // 备案号 萌ICP备20220618
  ...
  COMMENT_VALINE_APP_ID: process.env.NEXT_PUBLIC_VALINE_ID || 'mHGMWowK5x4tVcTvVkRCdv7D-MdYXbMMI', // Valine @see https://valine.js.org/quickstart.html 或 https://github.com/stonehank/react-valine#%E8%8E%B7%E5%8F%96app-id-%E5%92%8C-app-key
  COMMENT_VALINE_APP_KEY: process.env.NEXT_PUBLIC_VALINE_KEY || '80Sxfen0Jcxi86uRCgyb3Glk',
  COMMENT_VALINE_SERVER_URLS: process.env.NEXT_PUBLIC_VALINE_SERVER_URLS || 'https://mhgmwowk.api.lncldglobal.com', // 该配置适用于国内自定义域名用户, 海外版本会自动检测(无需手动填写) @see https://valine.js.org/configuration.html#serverURLs
  COMMENT_VALINE_PLACEHOLDER: process.env.NEXT_PUBLIC_VALINE_PLACEHOLDER || '说两句~', // 可以搭配后台管理评论 https://github.com/DesertsP/Valine-Admin  便于查看评论，以及邮件通知，垃圾评论过滤等功能
